...
//  Common ids
    ...
    val committee: ResponseData? = null,
    @SerialName("region")
    ...
    val coordinates: ResponseData? = null,
    @SerialName("minDays")
    ...
    val mainInfo: ResponseData? = null,
    @SerialName("rules")
    val rules: ResponseData? = null,
    @SerialName("isFree")
    ...
    val dateRange: ResponseData? = null,
    @SerialName("dates")
    val dates: ResponseData? = null,
    @SerialName("owner")
    val owner: ResponseData? = null,
    @SerialName("unit")
    val unit: ResponseData? = null,
    @SerialName("admin")
    val admin: ResponseData? = null,
    @SerialName("from")
    val from: Long? = null,
    @SerialName("to")
    val to: Long? = null,
    ...
    @SerialName("services")
    val services: List<ResponseData>? = null,
